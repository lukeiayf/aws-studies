• An EBS (Elastic Block Storage) Volume is a network drive (think of it as an usb stick) you can attach to your [[EC2 instance]] while they run
- It provides **BLOCK LEVEL STORAGE** (See [[Storage Types]])
